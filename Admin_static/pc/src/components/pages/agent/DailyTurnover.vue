  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <!-- 查询 -->
          <div style="border: solid rgb(211, 211, 211) 1px;">
            <div class="top">
                <label>时间范围：</label>
                <DatePicker type="daterange" split-panels placeholder="日期" size="small" style="width: 200px"></DatePicker>
                <label>用户名：</label>
                <Input v-model="id" placeholder="请输入..." size="small" style="width: 200px;"></Input>
            </div>
            <div class="top">
                <label>输入销售范围：</label>
                <Input v-model="id" placeholder="请输入..." size="small" style="width: 200px;"></Input>
                <label>~</label>
                <Input v-model="id" placeholder="请输入..." size="small" style="width: 200px; margin-right: 10px;"></Input>
                <Select v-model="query" size="small" style="width:100px; margin-right: 10px;">
          ...
          <div style="margin-top: 10px;"><label>总计：</label>0</div>    
          <!-- 遮罩层 -->
