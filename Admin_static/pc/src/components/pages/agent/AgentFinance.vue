    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
              ...
              <Input v-model="id" placeholder="请输入..." size="small" style="width:200px; margin-left: 10px;"></Input>
          ...
          <div class="top">
              ...
              <label>请输入金额</label>
              <Input v-model="id" placeholder="请输入..." size="small" style="width:200px; margin-left: 10px;"></Input>
              <Button type="primary" size="small" @click="lookup">转账</Button>
          </div>
          <!-- 主页面内容 -->
          <div class="center" >
  ...
  data () {
    return {
        ...
        columns: [
            {title: 'ID',key: 'pay'},
            {title: '用户名',key: 'id'}, 
            {title: '真实姓名',key: 'money'},
            {title: '手机',key: 'volue'},
            {title: '加入时间',key: 'gift'},
            {title: '余额',key: 'address'}
        ],
        data: [ // 数据表数据
            {
                pay: 'Android', // 支付类型
