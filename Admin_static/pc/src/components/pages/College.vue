...
export default {
  ...
  methods: {
    drawLine1(){
        ...
        let myChart = this.$echarts.init(document.getElementById('myChart1'),'dark')
        // 绘制图表
        myChart.setOption({
            title: { text: 'echarts' },
            tooltip: {},
    ...
    drawLine2(){
        // 基于准备好的dom，初始化echarts实例
        let myChart = this.$echarts.init(document.getElementById('myChart2'),'light')
        // 绘制图表
        myChart.setOption({
            series : [
                {
    ...
    drawLine4(){
        // 基于准备好的dom，初始化echarts实例
        let myChart = this.$echarts.init(document.getElementById('myChart4'),'light')
        // 绘制图表
        myChart.setOption({
