  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>类型：</label>
              <Select v-model="query" size="small" style="width:150px; margin-right: 15px;">
              ...
              <Button type="primary" size="small" @click="add">管理员批量添加</Button>
          </div>
          <!-- 主页面内容 -->
          <div class="center" >
          ...
          <!-- 新增页面 -->
            <div class="pop" v-if="showNonecreate">
                <Form :label-width="80">
                    ...
                    <FormItem label="用户ID：">
                        <Input v-model="address" type="textarea" :autosize="{minRows:12,maxRows: 12}" placeholder="请输入..."></Input>
                    </FormItem>
                    <FormItem>
                ...
                <p>说    明：多账号添加以"|"分隔如：9158666|915888</p>
            </div>
          <!-- 分页页面 -->
            <div class="bottom">
  ...
  data () {
    return {
        ...
        columns: [
            {title: '房间ID',key: 'pay'},
            {title: '家族名',key: 'id'}, 
            {title: '管理ID',key: 'money'},
            {title: '管理昵称',key: 'volue'},
