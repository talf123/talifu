...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '支付类型',key: 'pay',width:200},
            {title: '商品ID',key: 'id',width:200}, 
            {title: '金额',key: 'money',width:120},
            {title: '币值',key: 'volue',width:120},
            {title: '赠送币',key: 'gift',width:120},
            {title: '说明',key: 'address',width:200},
            {title: '操作',slot: 'action',align: 'center',width:166}
        ],
        tabledata: [ // 数据表数据
            {
                pay: 'Android', // 支付类型
