  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>用户idx：</label>
                <Input v-model="add" size="small" placeholder="IDX" style="width: 200px" />
                    <label>状态：</label>
            ...
            <Button type="primary" size="small" @click="newadd">添加</Button>
          </div>
          <div class="top">
            <label>用户idx：</label>
                <Input v-model="id" size="small" placeholder="IDX" style="width: 200px" />
...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '编号',key: 'pay',width:120},
            {title: '用户编号',key: 'id',width:167}, 
            {title: '用户昵称',key: 'money',width:180},
            {title: '房间号',key: 'volue',width:130},
            {title: '礼物',key: 'gift',width:170},
            {title: '时间',key: 'gift',width:160},
            {title: '状态',key: 'gift',width:100},
