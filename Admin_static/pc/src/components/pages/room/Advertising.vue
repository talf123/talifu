...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '标题',key: 'pay',width:120},
            {title: '图片',key: 'id',width:180}, 
            {title: '链接',key: 'money',width:180},
            {title: '房间',key: 'volue',width:100},
            {title: '开始时间',key: 'gift',width:150},
            {title: '结束时间',key: 'address',width:150},
            {title: '排序',key: 'address',width:100},
            {title: '分包展示',key: 'address',width:120},
