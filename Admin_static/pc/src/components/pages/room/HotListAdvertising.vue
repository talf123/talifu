...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '广告标题',key: 'id',width: 130}, 
            {title: '投放平台',key: 'money',width: 137},
            {title: '小图',key: 'volue',width: 100},
            {title: '大图',key: 'gift',width: 100},
            {title: '最近上架时间',key: 'gift',width: 180},
            {title: '最近下架时间',key: 'gift',width: 180},
            {title: '展示量',key: 'gift',width: 100},
            {title: '点击量',key: 'address',width: 100},
            {title: '操作',slot: 'action',align: 'center',width: 100}
            ],
        columns2: [
            {title: '类别',key: 'pay' ,width: 100},
            {title: '广告标题',key: 'id',width: 130}, 
            {title: '投放平台',key: 'money',width: 137},
            {title: '小图',key: 'volue',width: 100},
            {title: '大图',key: 'gift',width: 100},
