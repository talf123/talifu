  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <!-- 查询 -->
          <div class="top">
            <label>概率设置礼物选择：</label>
              <Select v-model="query" size="small" style="width:200px">
                  <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
              </Select>
              <Button type="primary" size="small" @click="">更新选定礼物版本</Button>
          </div>
          <div class="top">
            <label>获奖倍数：</label>
          ...
          <div class="center" >
            ...
            <Button type="primary" size="small" @click="up" style="margin-top: 10px;">更新概率</Button>
          </div>
          <!-- 遮罩层 -->
          ...
          <!-- 编辑页面 -->
            <div class="pop" v-if="showNoneUpdate">
                <Form :label-width="80">
                    ...
                    <FormItem>
                        <Button type="primary" @click="editadd">保存</Button>
