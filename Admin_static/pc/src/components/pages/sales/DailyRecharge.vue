  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>时间选择：</label>
                <DatePicker type="daterange" v-model="query_data" size="small" split-panels placeholder="日期" style="width: 180px"></DatePicker>
            <label>对比方式：</label>
  ...
  data () {
    return {
        ...
        columns: [
            ...
            {title: '101—1000',key: ''},
            {title: '1001—5000',key: ''},
            {title: '5001—20000',key: ''},
            {title: '20001—50000',key: ''},
            {title: '50000以上',key: ''}
        ],
        data: [ // 数据表数据
            {
