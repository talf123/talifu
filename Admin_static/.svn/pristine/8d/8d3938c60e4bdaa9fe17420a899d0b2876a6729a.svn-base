          ...
          <div class="center" >
            <Table border :columns="columns" :data="data" class="table"  ref="table">
                ...
                <template slot-scope="{ row, index }" slot="action">
                    <Button type="text" size="small" style="margin-right: 5px" @click="update(row)">xxx</Button>
                    <Button type="text" size="small" @click="remove(index,row)">xxx</Button>
                </template>
            </Table>
          </div>
          <!-- 遮罩层 -->
...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '申请ID',key: 'pay',width: 150},
            {title: '姓名',key: 'id',width: 150}, 
            {title: '身份证号',key: 'money',width: 150},
            {title: '手机号',key: 'volue',width: 150},
            {title: '支付宝',key: 'gift',width: 150},
            {title: '实名认证',key: 'address',width: 150},
            {title: '开户名',key: '',width: 150},
            {title: '银行卡',key: '',width: 150},
            {title: '开户行',key: '',width: 150},
            {title: '省份城市',key: '',width: 150},
            {title: '视频截图',key: '',width: 150},
            {title: '证件照图',key: '',width: 150},
            {title: '申请日期',key: '',width: 150},
            {title: '申请状态',key: '',width: 150},
            {title: '提现状态',key: '',width: 150},
