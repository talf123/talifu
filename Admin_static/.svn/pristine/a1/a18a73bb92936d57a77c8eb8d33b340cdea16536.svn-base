        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>用户idx：</label>
              ...
              <Button type="primary" @click="rec">礼物热推添加</Button>
  ...
  data () {
    return {
        ...
        columns: [
            {title: '编号',key: 'pay'},
            {title: '房间ID',key: 'id'}, 
            {title: '主播ID',key: 'money'},
            {title: '昵称',key: 'volue'},
            {title: '视频',key: 'gift'},
            {title: '图像',key: 'address'},
            {title: '礼物',key: 'address'},
...
.main{
    ...
    .top{margin-top:20px; margin-left: 20px; display: flex; font-size: 20px;
        button{
              margin-left: 15px;
          }
        label{
