  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>直播时间统计：</label>
            <DatePicker type="daterange" v-model='datatime' size="small" split-panels placeholder="时间" style="width: 200px"></DatePicker>
            <label>主播IDX：</label>
            <Input v-model="id" size="small" placeholder="IDX" style="width: 150px" />
            <label>房间ID：</label>
            <Input v-model="pay" size="small" placeholder="ID" style="width: 150px" />
...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '编号',key: 'pay',width:116},
            {title: '主播昵称',key: 'id',width:200}, 
            {title: '直播时长',key: 'money',width:180},
            {title: '室主',key: 'volue',width:120},
            {title: '管理',key: 'gift',width:120},
            {title: '所属房间',key: 'address',width:150},
            {title: '点歌娃娃数',key: 'address',width:120},
