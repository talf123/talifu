<template>
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
            ...
            <div class="top">
                <label>时间：</label>
                    <DatePicker type="daterange" size="small" split-panels placeholder="时间范围" style="width: 180px"></DatePicker>
                    <Select v-model="pay" size="small" style="width:120px; margin-left: 10px;">
                        <Option v-for="item in cityList" size="small" :value="item.value" :key="item.value">{{ item.label }}</Option>
                    </Select>
                    <Select v-model="pay" size="small" style="width:150px; margin-left: 10px;">
            ...
            <div class="top">
                <label>用户ID：</label>
                    <Input v-model="id" size="small" placeholder="请输入..."  style="width: 120px"></Input>
                <Button type="primary" size="small" @click="lookup">头像锁定</Button>
            </div>
            <!-- 主页面内容 -->
            <div class="center" >
                <Table border :columns="columns" :data="tabledata" class="table"  ref="table">
                    ...
                    <template slot-scope="{ row, index }" slot="action">
                        <Button type="text" size="small" @click="update(row)"></Button>
                        <Button type="text" size="small" @click="remove(index,row)"></Button>
                    </template>
                </Table>
            </div>
            <!-- 遮罩层 -->
...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '用户IDX',key: 'pay',width:120},
            {title: '昵称',key: 'id',width:120}, 
            {title: '星级',key: 'money',width:120},
            {title: '签约',key: 'volue',width:120},
            {title: '原头像',key: 'gift',width:200},
            {title: '待审核头像',key: 'address',width:200},
            {title: '提交时间',key: 'address',width:180},
            {title: '审核状态',key: '',width:180},
            {title: '操作时间	',key: 'address',width:180},
            {title: '操作人',key: 'address',width:120},
