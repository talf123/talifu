  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <!-- 查询 新增 -->
          <div class="top">
              <Button type="primary" size="small" @click="add">新增主播</Button>
            <label>主播IDX：</label>
            <Input v-model="id" size="small" placeholder="请输入..." style="width:200px;"></Input>
            <Button type="primary" size="small" @click="lookup">搜索</Button>
              <Select v-model="query" size="small" style="width:150px; margin-left: 5px;">
                  <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
              </Select>
              <Button type="primary" size="small" @click="lookup">确认</Button>
          </div>
          <!-- 主页面内容 -->
          <div class="center" >
          ...
          <!-- 新增页面 -->
            <div class="pop" v-if="showNonecreate">
                <h1 style="margin-bottom: 20px;">新增主播</h1>
                <Form :label-width="80">
                    <FormItem label="新增：">
                        <Input v-model="address" type="textarea" :autosize="{minRows: 10,maxRows: 10}" placeholder="请输入..."></Input>
                    </FormItem>
                    <p>输入主播id用英文逗号隔开，例：111,222,333,444,555</p>
                    <FormItem>
