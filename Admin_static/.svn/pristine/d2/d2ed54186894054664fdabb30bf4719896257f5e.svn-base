        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>手机号：</label>
                ...
                <Button type="primary" size="small" @click="create">清除</Button>
          </div>
            <fieldset style="padding-bottom: 20px;">
                <legend style="text-align: left;">绑定手机</legend>
                <div class="top">          
                    <label>手机号：</label>
                        <Input size="small" v-model="id" placeholder="请输入..." style="width: 200px;"></Input>
                    <label>IDX：</label>
                        <Input size="small" v-model="id" placeholder="请输入..." style="width: 200px;"></Input>
                        <Button type="primary" size="small" @click="create">添加绑定</Button>
                </div>
            </fieldset>
          <!-- 主页面内容 -->
          <div class="center" >
