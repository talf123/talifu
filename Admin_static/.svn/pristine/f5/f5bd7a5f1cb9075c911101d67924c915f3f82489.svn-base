  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>用户idx：</label>
                <Input v-model="rec_id" placeholder="IDX" style="width: 150px" size='small'/>
                <Select v-model="rec_time" style="width:150px; margin-left: 15px;" size='small'>
          ...
          <div class="top">
            <label>用户idx：</label>
                <Input v-model="id" size='small' placeholder="IDX" style="width: 150px" />
            <label>房间id：</label>
                <Input v-model="id" size='small' placeholder="ID" style="width: 150px" />
        ...
        <!-- 新增页面 -->
         <div class="pop" v-if="showNonecreate">
            <Form :label-width="80">
                <FormItem label="二级添加：">
                    <Input v-model="address" type="textarea" :autosize="{minRows: 15,maxRows: 15}" placeholder="请输入..."></Input>
                </FormItem>
                <FormItem>
                    <Button style="margin-left: -60px;" type="primary" @click="newadd">保存</Button>
...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '编号',key: 'pay',width:100},
            {title: '用户编号',key: 'id',width:150}, 
            {title: '用户昵称',key: 'money',width:167},
            {title: '房间号',key: 'volue',width:150},
            {title: '时间',key: 'gift',width:150},
            {title: '推荐时长',key: 'gift',width:100},
            {title: '操作人',key: 'gift',width:160},
