        ...
        <div class="main" :style="widthMain">
          ...
          <!-- 查询 总计 -->
            ...
            <div style="display:flex; font-size:15px; margin-left: 20px; margin-top: 15px;">
                <label>房间总消耗：</label><span style="color:red; margin-right: 10px;">1</span>
                <label>房间总流水：</label><span style="color:red; margin-right: 10px;">2</span>
                <label>房间总娃娃：</label><span style="color:red; margin-right: 10px;">3</span>
            </div>
          <!-- 主页面内容 -->
          <div class="center" >
