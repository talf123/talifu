        ...
        <div class="main" :style="widthMain">
          ...
          <!-- 查询 总计 -->
            <div class="top">
                ...
                <Button type="primary" size="small" @click="lookup">昨日</Button>
            </div>
            <div style="display:flex; font-size:12px; margin-left: 20px; margin-top: 15px;">
                <label>流水总计：</label><span style="color:red; margin-right: 10px;">1212121212121</span>
                <label>消耗总计：</label><span style="color:red; margin-right: 10px;">12121212121212</span>
                <label>中奖金额总计：</label><span style="color:red; margin-right: 10px;">121212121212123</span>
                <label>系统盈利总计：</label><span style="color:red; margin-right: 10px;">41212121212121212</span>
                <label>系统盈利率：</label><span style="color:red; margin-right: 10px;">51122</span>
            </div>
          <!-- 主页面内容 -->
          <div class="center" >
