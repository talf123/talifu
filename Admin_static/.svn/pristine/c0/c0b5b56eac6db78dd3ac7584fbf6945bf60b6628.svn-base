        ...
        <div class="main" :style="widthMain">
          ...
          <!-- 查询 新增 -->
            <div class="top">
                ...
                <label>房间ID：</label>
                <Input v-model="RoomID" placeholder="ID" size="small" style="width: 200px" />
...
export default {
  ...
  data () {
    return {
        ...
        columns: [ // 表格列名称
            {title: '房间ID',key: 'roomid',width: 120}, 
            {title: '家族名称',key: 'familyname',width: 120},
            {title: '是否签约',key: 'Signing',width: 120},
            {title: '支付宝账号',key: 'zfb_number',width: 120},
            {title: '支付宝昵称',key: 'zfb_name',width: 120},
            {title: '手机号',key: 'phone_number',width: 120},
            {title: '家族类型',key: 'Family_type',width: 120},
            {title: '录入时间',key: 'input_time',width: 120},
            {title: '归属运营',key: 'Sub_operation',width: 120},
            {title: '归属小组',key: 'Sub_group',width: 120},
