  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>用户ID：</label>
                <Input v-model="query" size="small" placeholder="请输入..." style="width:200px;"></Input>
          ...
          <!-- 删除弹出窗口 -->
            <div class="pop" v-if="showNoneUpdate">
                <Form :label-width="80">
                    <p style="font-size:20px; margin-bottom: 30px;">确定要删除该用户的锁定吗？</p>
                    <div>
...
export default {
  ...
  methods: {
      ...
      remove: function(row) { // 删除
            ...
            this.showNoneUpdate = true, // 修改页面弹出控制
            this.id = row.id
            console.log(this.id)
      },
      lookup: function () { // 查找
