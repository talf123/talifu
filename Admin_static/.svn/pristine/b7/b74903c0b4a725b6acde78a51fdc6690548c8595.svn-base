    ...
    <div class="body_main">
        ...
        <div class="top">
            ...
            <label>原因：</label>
              ...
              <Button type="primary" size="small" @click="lookup">添加</Button>
            ...
            <div class="pop" v-if="showNonecreate">
                <Form :label-width="90">
                    <FormItem label="请输入IDX：">
                        <Input v-model="address" type="textarea" :autosize="{minRows: 7,maxRows: 7}" placeholder="请输入..."></Input>
                    </FormItem>
                    <FormItem label="类型：">
                        <Select v-model="pay">
                            <Option v-for='item in cityList' :value='item.value' :key='item.value'>{{item.label}}</Option>
  ...
  data () {
    return {
        ...
        columns: [
            ...
            {title: '昵称',key: 'id'}, 
            {title: '类型',key: 'money'},
            {title: '是否红人',key: 'volue'},
            {title: '是否签约',key: 'gift'},
            {title: '拉黑天数',key: 'address'},
            {title: '原因',key: 'address'},
