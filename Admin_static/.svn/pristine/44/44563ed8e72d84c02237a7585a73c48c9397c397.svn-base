  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>用户IDX：</label>
                <Input v-model="value" size="small" placeholder="Enter something..." style="width: 200px" /> 
          ...
          <div class="center" >
            <Table border :columns="columns" :data="data" class="table"  ref="table">
                ...
                <template slot-scope="{ row, index }" slot="action">
                    <Button type="text" size="small" @click="remove(index,row)">清币</Button>
                </template>
            </Table>
          </div>
          <!-- 遮罩层 -->
  ...
  data () {
    return {
        ...
        columns: [
            ...
            {title: '昵称',key: 'money'},
            {title: '金币',key: 'volue'},
            {title: '注册时间',key: 'volue'},
            {title: '最后登录时间',key: 'volue'},
