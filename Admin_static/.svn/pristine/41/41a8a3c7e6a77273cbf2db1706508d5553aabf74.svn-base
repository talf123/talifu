        ...
        <div class="main" :style="widthMain">
            ...
            <div class="fullpop" v-if="showNonelabelmanagement">
                <div class="top">
                    ...
                    <Button size="small" @click="close()">在线礼物</Button>
                </div>
                <!-- 标签管理页面表格 -->
                <div class="center" >
...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [ // 在线礼物页面表格
            {title: '排序',key: 'pay',width:100},
            {title: 'ID',key: 'id',width:120}, 
            {title: '名称',key: 'money',width:120},
            {title: '图片',key: 'volue',width:120},
            {title: '说明',key: 'gift',width:120},
            {title: '价格',key: 'gift',width:120},
            {title: '获得比例',key: 'gift',width:180},
            {title: '房间比例',key: 'gift',width:180},
            {title: '动画',key: 'gift',width:120},
            {title: '平台',key: 'gift',width:120},
            {title: '标签',key: 'address',width:120},
