  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>ID：</label>
              <Input v-model="id" placeholder="请输入..." style="width: 200px;" size="small"></Input>
