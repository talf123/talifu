...
<div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
            ...
            <!-- 查询 -->
            <div class="top">
                <Select v-model="pay" size="small" style="width: 200px;">
                    <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
                <Input v-model="id" size="small" placeholder="请输入..." style="width: 200px; margin-left: 15px;" />
  ...
  data () {
    return {
        ...
        columns: [
            ...
            {title: '用户IDX',key: 'id'}, 
            {title: '昵称',key: 'money'},
            {title: '禁言开始时间',key: 'volue'},
            {title: '禁言结束时间',key: 'gift'},
