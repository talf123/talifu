  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <Button type="primary" size="small" @click="lookup">批量上架</Button>
            <Button type="primary" size="small" @click="create">批量下架</Button>
            <Button type="primary" size="small" @click="create">添加靓号</Button>
          </div>
          <div class="top">
              <p style="color:red">符合要求的号码共有：0个</p>
          </div>
          <!-- 主页面内容 -->
          <div class="center" >
            <Table border :columns="columns" :data="data" class="table"  ref="table" @on-select="" @on-select="">
