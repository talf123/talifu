        ...
        <div class="main" :style="widthMain">
          ...
          <!-- 新增页面 -->
            <div class="pop" v-if="showNonecreate">
                <h1 style="margin-bottom: 15px;">管理员添加</h1>
                <Form :label-width="80">
                    <FormItem label="账号：">
                        <Input v-model="id" placeholder="请输入..."></Input>
                    </FormItem>
                    <FormItem label="密码：">
                        <Input v-model="money" type="password" placeholder="请输入..."></Input>
                    </FormItem>
                    <FormItem label="确认密码：">
                        <Input v-model="volue" type="password" placeholder="请输入..." ></Input>
                    </FormItem>
                    <FormItem label="真实姓名：">
          ...
          <!-- 修改编辑页面 -->
            <div class="pop" v-if="showNoneUpdate">
                <Form :label-width="80">
                    <FormItem label="账号：">
                        <Input v-model="id" disabled placeholder="请输入..."></Input>
                    </FormItem>
                    <FormItem label="真名：">
