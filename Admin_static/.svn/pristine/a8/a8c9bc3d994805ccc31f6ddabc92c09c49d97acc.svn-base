  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>开始时间：</label>
                <DatePicker type="date" size="small" placeholder="日期" style="width: 150px"></DatePicker>
            <label>主播IDX：</label>
                <Input v-model="id" size="small" placeholder="请输入..." style="width:180px;"></Input>
  ...
  data () {
    return {
        ...
        columns: [
            ...
            {title: '房间流水',key: 'pay',width:100},
            {title: '主播IDX',key: 'id',width:100}, 
            {title: '主播昵称',key: 'id',width:100}, 
            {title: '主播流水',key: 'money',width:100},
            {title: '在线时长',key: 'money',width:100},
            {title: '是否违规',key: 'money',width:100},
            {title: '违规时间',key: 'volue',width:100},
            {title: '有效关注',key: 'volue',width:100},
            {title: '粉丝数量',key: 'volue',width:100},
