            ...
            <div class="pop" v-if="showNonecreate">
                <Form :label-width="90">
                    <FormItem label="请输入IDX：">
                        <Input v-model="address" type="textarea" :autosize="{minRows: 12,maxRows: 15}" placeholder="请输入..."></Input>
                    </FormItem>
                    <p style="margin: 20px 0px 20px 0px;">批量添加请用英文的‘,’将idx隔开，例：22222,33333,44444</p>
                    <FormItem>
