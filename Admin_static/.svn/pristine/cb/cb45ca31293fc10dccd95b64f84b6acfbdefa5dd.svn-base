    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
              ...
              <div class="fex">
                <label>用户idx：</label>
                <Input v-model="value" placeholder="IDX" style="width: 200px" size="small" />
                <label>封播时间：</label>
                <Select v-model="query" style="width:150px" size="small">
                ...
                <Button type="primary" size="small" @click="lookup">踢麦</Button>
              </div>
                <br>
              ...
              <div class="fex">
                ...
                <Button type="primary" size="small" @click="lookup">封号</Button>
                <Button type="primary" size="small" @click="lookup">封号封设备</Button>
                <Button type="primary" size="small" @click="lookup">封设备</Button>
              </div>
                <br>
              ...
              <div class="fex">
                <label>用户idx：</label>
                <Input v-model="value" placeholder="IDX" style="width: 200px" size="small" />
                <Button type="primary" size="small" @click="lookup">下星</Button>
              </div>
                <br>
              ...
              <div class="fex">
                <label>用户idx：</label>
                <Input v-model="value" placeholder="IDX" style="width: 200px" size="small" />
                <Select v-model="query" style="width:150px; margin-left: 15px;" size="small">
                    <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                </Select>
  ...
  data () {
    return {
        ...
        columns: [
            {title: 'idx',key: 'pay'},
            {title: '到期时间',key: 'id'}, 
            {title: '添加时间',key: 'money'},
            {title: '操作人	',key: 'volue'},
            {title: '备注',key: 'gift'}
        ],
        // columns: [
        //     {title: 'idx',key: 'pay',width:150},
        //     {title: '到期时间',key: 'id',width:180}, 
        //     {title: '添加时间',key: 'money',width:180},
        //     {title: '操作人	',key: 'volue',width:180},
        //     {title: '备注',key: 'gift',width:437}
        // ],
        data: [ // 数据表数据
            {
                pay: 'Android', // 支付类型
...
.main{
    ...
    .center{width:100%; margin-top:20px; float: left;}
    .bottom{width:100%; margin-top:15px; float: left;}
    .fex {
        display:flex;
    }
}
