  ...
  data () {
    return {
        ...
        columns: [
            {title: '房间ID',key: 'pay'},
            {title: '家族名称',key: 'pay'},
            {title: '大礼物流水',key: 'id',sortable: true}, 
            {title: '小礼物流水',key: 'id',sortable: true}, 
            {title: '其他礼物流水',key: 'money',sortable: true},
            {title: '大礼物消耗',key: 'money',sortable: true},
            {title: '小礼物消耗',key: 'volue',sortable: true},
            {title: '其他礼物消耗',key: 'volue',sortable: true},
            {title: '小组',key: 'gift'},
            {title: '运营',key: 'gift'}
        ],
        data: [ // 数据表数据
