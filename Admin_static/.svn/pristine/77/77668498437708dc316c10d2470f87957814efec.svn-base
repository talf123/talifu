  ...
  <div class="content">
    ...
    <div class="body_main">
        ...
        <div class="main" :style="widthMain">
          ...
          <div class="top">
            <label>用户idx：</label>
                <Input v-model="rec_id" size="small" placeholder="IDX" style="width: 200px" ></Input>
            <Button type="primary" size="small"  @click="rec">添加一级推荐</Button>
          </div>
          <div class="top">
            <label>用户idx：</label>
...
export default {
  ...
  data () {
    return {
        ...
        // 表格列名称
        columns: [
            {title: '编号',key: 'pay',width:180},
            {title: '用户编号',key: 'id',width:210}, 
            {title: '房间号',key: 'money',width:207},
            {title: '时间',key: 'volue',width:230},
            {title: '操作人',key: 'gift',width:180},
