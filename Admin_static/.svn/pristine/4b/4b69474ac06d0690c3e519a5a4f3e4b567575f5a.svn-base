            ...
            <div class="center" >
                <Table border :columns="columns" :data="tabledata" class="table"  ref="table">
                    ...
                    <template slot-scope="{ row, index }" slot="action">
                        <Button type="text" size="small" @click="update(row)">xxx</Button>
                        <Button type="text" size="small" @click="remove(index,row)">yyy</Button>
                    </template>
                </Table>
            </div>
            <!-- 遮罩层 -->
  ...
  data () {
    return {
        ...
        columns: [
            ...
            {title: '签约',key: 'volue'},
            {title: '原头像',key: 'gift'},
            {title: '待审核头像',key: 'address'},
            {title: '提交时间',key: 'address'},
            {title: '审核状态',key: ''},
            {title: '操作时间	',key: 'address'},
